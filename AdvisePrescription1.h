...
namespace Windoform {
	...
	/// <summary>
	/// Summary for AdvisePrescription1
	/// </summary>
	public ref class AdvisePrescription1 : public System::Windows::Forms::Form
	{
	public:
		AdvisePrescription1(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(423, 4);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 35;
			this->dataGridView1->Size = System::Drawing::Size(966, 647);
			this->dataGridView1->TabIndex = 3;
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &AdvisePrescription1::dataGridView1_CellContentClick);
			// 
			// ID
			// 
			...
			this->buttonEnter->Location = System::Drawing::Point(124, 488);
			...
			this->buttonEnter->Click += gcnew System::EventHandler(this, &AdvisePrescription1::buttonEnter_Click);
			// 
			// label4
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &AdvisePrescription1::label4_Click);
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Segoe UI", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(183, 136);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(150, 30);
			this->textBox1->TabIndex = 19;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &AdvisePrescription1::textBox1_TextChanged);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &AdvisePrescription1::label1_Click);
			// 
			// textBox2
			// 
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Segoe UI", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(183, 254);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(202, 177);
			this->textBox2->TabIndex = 25;
			this->textBox2->Text = L"";
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &AdvisePrescription1::richTextBox1_TextChanged);
			// 
			// AdvisePrescription1
			// 
			...
			this->Name = L"AdvisePrescription1";
			this->Text = L"AdvisePrescription1";
			this->Load += gcnew System::EventHandler(this, &AdvisePrescription1::AdvisePrescription1_Load);
...
#pragma endregion
	...
	private: System::Void AdvisePrescription1_Load(System::Object^ sender, System::EventArgs^ e) {
		viewtable();
	}
private: System::Void buttonEnter_Click(System::Object^ sender, System::EventArgs^ e) {
	if (textBox1->Text == "" || textBox2->Text == "") {
		...
		if (!b) {
			if (y == 1) {
				ofstream obj;
				obj.open("prescription.txt", ios::app);
				obj << v1 << ",";
				v = textBox2->Text;
				v1 = msclr::interop::marshal_as<string>(v);
				obj << v1 << "\n";
				MessageBox::Show("Prescription Advised Successfully !");
				obj.close();
				this->Close();
			}
			else {
			...
			MessageBox::Show("Prescription of this Patient Already Exist !");
		}
	}
}
