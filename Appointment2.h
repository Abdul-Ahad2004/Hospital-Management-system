...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(103, 174);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(432, 46);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Make Appointments Page";
			this->label1->Click += gcnew System::EventHandler(this, &Appointment2::label1_Click);
			// 
			// Enter
			// 
			...
			this->Enter->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Enter->Location = System::Drawing::Point(87, 277);
			this->Enter->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->Enter->Name = L"Enter";
			this->Enter->Size = System::Drawing::Size(223, 53);
			this->Enter->TabIndex = 6;
			this->Enter->Text = L"For New Patient";
			this->Enter->UseVisualStyleBackColor = false;
			this->Enter->Click += gcnew System::EventHandler(this, &Appointment2::Enter_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(361, 277);
			this->button1->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(261, 53);
			this->button1->TabIndex = 7;
			this->button1->Text = L"For Existing Patient";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Appointment2::button1_Click);
			// 
			// Appointment2
			// 
