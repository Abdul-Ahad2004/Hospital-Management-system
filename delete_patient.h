...
namespace Windoform {
	...
	/// <summary>
	/// Summary for delete_patient
	/// </summary>
	public ref class delete_patient : public System::Windows::Forms::Form
	{
		int Index;
	public:
		delete_patient(void)
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(10) {
				this->ID, this->Password,
					this->Name1234, this->Gender, this->Age, this->Disease, this->Medicine, this->Address, this->Contact, this->Delete
			});
			this->dataGridView1->Location = System::Drawing::Point(248, 0);
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &delete_patient::dataGridView1_CellContentClick);
			// 
			// ID
			// 
			...
			this->Import->Location = System::Drawing::Point(37, 249);
			this->Import->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->Import->Name = L"Import";
			this->Import->Size = System::Drawing::Size(166, 61);
			this->Import->TabIndex = 5;
			this->Import->Text = L"Import Data";
			this->Import->UseVisualStyleBackColor = true;
			this->Import->Click += gcnew System::EventHandler(this, &delete_patient::Import_Click);
			// 
			// delete_patient
			// 
			...
			this->Name = L"delete_patient";
			this->Text = L"delete_patient";
			this->Load += gcnew System::EventHandler(this, &delete_patient::delete_patient_Load);
...
#pragma endregion
	...
	private: System::Void dataGridView1_CellContentClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
		...
		{
			Windows::Forms::DialogResult result = MessageBox::Show("Sorry You can not perform action ! ", "Confirmation", MessageBoxButtons::OKCancel, MessageBoxIcon::Error);
		}
	}
	private: System::Void delete_patient_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	};
}
