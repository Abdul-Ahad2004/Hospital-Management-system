...
namespace Windoform {
	...
	/// </summary>
	public ref class LoginFormA : public System::Windows::Forms::Form
	{
	public:
		LoginFormA(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LoginFormA::typeid));
			...
			this->label1->Location = System::Drawing::Point(172, 150);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(312, 46);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Admin Login Page";
			this->label1->Click += gcnew System::EventHandler(this, &LoginFormA::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(145, 37);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Admin ID:";
			this->label2->Click += gcnew System::EventHandler(this, &LoginFormA::label2_Click);
			// 
			// label3
			// 
			...
			this->Enter->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Enter->Location = System::Drawing::Point(263, 350);
			...
			this->Enter->Click += gcnew System::EventHandler(this, &LoginFormA::Enter_Click);
			// 
			// LoginFormA
			// 
			...
			this->Name = L"LoginFormA";
			this->Text = L"LoginFormA";
			this->Load += gcnew System::EventHandler(this, &LoginFormA::LoginFormA_Load);
...
#pragma endregion
	private: System::Void LoginFormA_Load(System::Object^ sender, System::EventArgs^ e) {
	}
