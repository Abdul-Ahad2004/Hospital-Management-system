...
namespace Windoform {
	...
	/// </summary>
	public ref class AppointmentU1 : public System::Windows::Forms::Form
	{
	public:
		AppointmentU1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AppointmentU1::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &AppointmentU1::button1_Click);
			// 
			// label9
			// 
			...
			this->label9->Size = System::Drawing::Size(252, 37);
			this->label9->TabIndex = 18;
			this->label9->Text = L"Enter New Details:";
			// 
			// AppointmentU1
			// 
			...
			this->Name = L"AppointmentU1";
			this->Text = L"AppointmentU1";
			this->Load += gcnew System::EventHandler(this, &AppointmentU1::AppointmentU1_Load);
...
#pragma endregion
	private: System::Void AppointmentU1_Load(System::Object^ sender, System::EventArgs^ e) {
	}
